...
[![Other](https://skillicons.dev/icons?i=symfony,wordpress,flask,java,spring,kotlin,go,ts,bootstrap,jquery,angular,vuejs,react,bitbucket,gitlab,github,aws,azure,gcp,mongodb,postgresql,cassandra,rabbitmq)](https://skillicons.dev)
